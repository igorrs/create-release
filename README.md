...
<a href="https://github.com/igorrs/create-release"><img alt="GitHub Actions status" src="https://github.com/igorrs/create-release/workflows/Tests/badge.svg"></a>
...
## Contributing
We would love you to contribute to `@igorrs/create-release`, pull requests are welcome! Please see the [CONTRIBUTING.md](CONTRIBUTING.md) for more information.
